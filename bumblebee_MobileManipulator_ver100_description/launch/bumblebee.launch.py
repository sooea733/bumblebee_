...
def generate_launch_description():
    # 패키지 경로
    bumblebee_pkg = get_package_share_directory('bumblebee_MobileManipulator_ver100_description')
    ...
    static_tf_pub_node = Node(
        ...
        name='zed_tf_pub',
        arguments=['0', '0', '0.2', '0', '0', '0', 'base_link', 'zed_camera_link'],
        output='screen'
    )
